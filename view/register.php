    ...
    <div class="w-full h-[100vh] grid grid-cols-5 overflow-hidden">
      <div class="col-span-5 md:col-span-3 flex items-center justify-center">
        <form class="w-[320px]" action="../controllers/Users.php" method="post">
          ...
          <div>
            <h2 class="text-xl font-bold">Register Page</h2>
          ...
          <div class="space-6 mt-6">
            <div class="space-y-4">
              ...
              <div class="flex gap-2">
                <div class="relative">            
                  <input class="border border-border rounded-md px-3 py-2 w-full focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent" placeholder="First Name" id="first-name" type="text" name="firstName" id="email" >
                </div>
                <div class="relative">
                  <input class="border border-border rounded-md px-3 py-2 w-full focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent" placeholder="Last Name" id="last-name" type="text" name="lastName" id="last-name" >
                </div>
              </div>
              <div class="relative">
                <i data-lucide="mail" class="w-7 h-7 p-1 absolute left-1.5 top-1/2 transform -translate-y-1/2"></i>
                <input class="border pl-10 border-border rounded-md px-3 py-2 w-full focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent" placeholder="Email" id="email" type="email" name="email" id="email" >
              </div>
              <div class="relative">
              ...
              <p class="text-sm mt-5 text-muted-foreground">Do you have an account? <a class="text-primary" href="./login.php">Login</a></p>
            </div>
          </div>
        </form>
      </div>
